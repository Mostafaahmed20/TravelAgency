...
export const translations = {
  en: {
    ...
    aboutStoryP1: 'Miles Travel is a premier travel agency specializing in delivering exceptional travel experiences across the Middle East and beyond. With years of expertise in the tourism industry, we pride ourselves on transforming travel dreams into unforgettable memories.',
    aboutStoryP2: "We offer a comprehensive range of services including luxury hotel bookings, customized tour packages, flight arrangements, and carefully curated experiences. Whether you're seeking a relaxing getaway, a cultural adventure, or a special celebration, our dedicated team is here to make your journey seamless and memorable.",
    aboutStoryP3: "At Miles Travel, we believe that travel is about creating stories and building connections. From the ancient temples of Egypt to the modern cities of Dubai, from the serene beaches of Sharm El Sheikh to the scenic mountains of Georgia - we help you explore the world with confidence and comfort.",
  ...
  ar: {
    ...
    travelPackages: 'الباقات السياحية',
    ...
    aboutStoryP1: 'مايلز ترافيل هي وكالة سفر رائدة متخصصة في تقديم تجارب سفر استثنائية عبر الشرق الأوسط وما بعده. مع سنوات من الخبرة في صناعة السياحة، نفخر بتحويل أحلام السفر إلى ذكريات لا تُنسى.',
    aboutStoryP2: 'نقدم مجموعة واسعة من الخدمات بما في ذلك حجوزات الفنادق الفاخرة، والباقات السياحية المخصصة، ورحلات الطيران، والجولات المنسقة بعناية. سواء كنت تبحث عن عطلة استرخاء، أو مغامرة ثقافية، أو احتفال بمناسبة خاصة، فإن فريقنا المتفاني موجود لجعل رحلتك سلسة ولا تُنسى.',
    aboutStoryP3: 'في مايلز ترافيل، نؤمن بأن السفر يتعلق بخلق قصص وبناء روابط. من المعابد القديمة في مصر إلى المدن الحديثة في دبي، ومن شواطئ شرم الشيخ الهادئة إلى جبال جورجيا الخلابة - نساعدك على استكشاف العالم بثقة وراحة.',
